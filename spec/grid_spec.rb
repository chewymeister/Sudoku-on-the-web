...
describe Grid do
  ...
  let(:hard_puzzle2) {"400000805030000000000700000020000060000080400000010000000603070500200000104000000"}
  ...
  xit 'returns the cells box index value' do
    expect(grid.board[3][8].box_index).to eq 6
  end
  
  xit 'returns an array of cells located in the appropriate box' do
    box_2 = grid.fetch_box 2
    expect(box_2).to be_an_instance_of Array
  end

  xit 'verifies there are only 9 elements after fetching a box' do
    box_3 = grid.fetch_box 3
    expect(box_3.flatten.count).to eq 9
  end

  xit 'matches the correct neighbours for box index' do
    grid.solve_board!
  ...
  it 'creates board string' do
    expect(grid.create_puzzle_string_of_current board).to be_an_instance_of String
  end
  ...
  it 'provides the correct values of puzzle in an array' do
    solved_board = ['2','6','9','4','1','3','8','7','5','7','4','3','2','8','5','1','9','6','8','1','5','6','9','7','4','2','3','3','9','6','1','8','2','5','4','7','5','2','8','6','7','4','3','1','9','1','7','4','3','5','9','2','6','8','7','3','1','9','2','4','6','5','8','4','5','2','8','6','7','9','3','1','9','8','6','5','3','1','7','4','2']
    grid.solve_board!

    expect(grid.provide_puzzle).to match_array solved_board
  end
end
